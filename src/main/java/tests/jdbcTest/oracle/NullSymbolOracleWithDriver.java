...
public class NullSymbolOracleWithDriver {

    static final String JDBC_DRIVER = "oracle.jdbc.OracleDriver";
    static final String DB_URL = "jdbc:oracle:thin:@192.168.15.19:1521:ORCL";

    static final String path = "jar:file:C:///JDBCDrivers/ojdbc14-10.2.0.3.0.jar!/";
    ...
    public static void main(String[] args) {
       ...
       //     Class.forName("oracle.jdbc.driver.OracleDriver");
            ...
            classLoader.loadClass(JDBC_DRIVER).newInstance();
            Driver drv2 = (Driver) classLoader.loadClass(JDBC_DRIVER).newInstance();



            System.out.println("Connecting to database...");

            Driver drv = (Driver) classLoader.loadClass(JDBC_DRIVER).newInstance();
