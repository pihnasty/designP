...
//--------------------------------------------------------------------------
*/
       String trustStorePathP12 = "C:\\MyCertificates\\oracle\\OracleNew\\ewallet_T_02.p12";
       Certificate certT= loadingCertificate ("JKS",trustStorePath, trustStorePass, "cn=vm-baninst1");
...
//---------------------------------------------------------------------------
        ...
        String keyStorePathP12 = "C:\\MyCertificates\\oracle\\OracleNew\\ewallet_K_02.p12";
   ...
   //     orapki wallet create -wallet %wallet_path% -auto_login
    ...
    private static Certificate [] loadingCertificateChain (String type, String store, String passord, String sertName)
        ...
        java.security.cert.Certificate[] chain = keyStore.getCertificateChain(sertName);
...
//  keyStore.load(new FileInputStream("output.p12"),"password".toCharArray());
    ...
    private static java.security.cert.Certificate[] loadingPrivateChain (String type, String store, String passord, String sertName) {
