 ...
 */
public class TestSSL2_Experiment {
...
*/
    ...
    //    loadingCertificate ("PKCS12","C:\\MyCertificates\\oracle\\2020_01_15\\ewallet.p12",  trustStoreWalletPass, "orakey");
       ...
       String trustStorePathP12 = "C:\\MyCertificates\\oracle\\OracleNew\\ewallet_T_04.p12";
       Certificate certT= loadingCertificate ("JKS",trustStorePath, trustStorePass, "cn=vm-baninst1");
       StoreCertificate("PKCS12","cn=vm-baninst1",trustStorePathP12, trustStoreWalletPass,certT);       // "PKCS12"
//---------------------------------------------------------------------------
        Certificate[] chain = loadingPrivateChain("JKS","C:\\MyCertificates\\oracle\\2020_01_14\\ewallet2.p12", trustStoreWalletPass, "orakey");
        Key key = loadingPrivateKey ("PKCS12",keyStorePath, keyStorePass, "orakey");

        String keyStorePathP12 = "C:\\MyCertificates\\oracle\\OracleNew\\ewallet_K_03.p12";
