...
/*
    ...
    private static final String trustStoreWalletPath = "C:\\MyCertificates\\oracle\\2019_12_20_testND\\wallet_trust\\ewallet.p12";
    private static final String keyStoreWalletPath   = "C:\\MyCertificates\\oracle\\2019_12_20_testND_Only\\wallet_pkey_only\\ewallet.p12";
...
*/
    ...
    private static final String trustStoreWalletPathP12 = "C:\\MyCertificates\\oracle\\OracleNew\\ewallet_T_02.p12";
    private static final String keyStoreWalletPathP12   = "C:\\MyCertificates\\oracle\\OracleNew\\ewallet_K_02.p12";
   // private static final String keyStoreWalletPathP12   = "C:\\MyCertificates\\oracle\\OracleNew\\ewallet2.p12";
    private static final String trustStoreWalletPass = "walletpass123";
    private static final String keyStoreWalletPass   = "walletpass123";
    ...
    private static final String typeSslAuthentication ="PKCS12";  //  "PKCS12";     "sso";


   // private static   String trustStoreWalletPathP12_test = "C:\\MyCertificates\\oracle\\2019_12_20_testND\\wallet_trust\\output.p12";
    ...
    private static  List<String>  getColumn(PreparedStatement stmt, String columnName) throws SQLException {
        ResultSet rs = stmt.executeQuery();
        String text = "";
        List<String> columnCells = new ArrayList<>();
        while (rs.next()) {
            columnCells.add( rs.getString(columnName) );
...
https://bugs.openjdk.java.net/browse/JDK-8214513
