...
public class JksOracleRootUserOnlyOnly {
   ...
   static final String DB_URL =  "jdbc:oracle:thin:@(DESCRIPTION=(ADDRESS=(PROTOCOL=TCPS)(HOST=192.168.13.155)(PORT=2484))(CONNECT_DATA=(SERVICE_NAME=orcl12.168.13.155)))";
    ...
    private static final String keyStoreWalletPath   = "C:\\MyCertificates\\oracle\\2019_12_20_testND_Only\\wallet_pkey_only_only\\cwallet.sso";
